...
const IconPicker = ({
  ...
  const [selectedIconKey, setSelectedIconKey] = useState<IconKeyType>(iconKey)
  const [displayedIconKeys, setDisplayedIconKeys] =
    useState<IconKeyType[]>(iconKeys)

  useEffect(() => {
    debouncedSearchQuery
      ? setDisplayedIconKeys(filterIconKeys(debouncedSearchQuery, iconKeys))
  ...
  const onButtonClick = useCallback(
    ...
    [onIconChange, selectedIconKey, iconKey],
  )
