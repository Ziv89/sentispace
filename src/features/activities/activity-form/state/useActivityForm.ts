import { getRandomIconKey, iconKeys, IconKeyType } from '@assets/icons'
import { copyDate, deepEqual } from '@utils/functions'
...
const useActivityForm = (activity?: Partial<Activity>) => {
  const initialState: ActivityFormState = useMemo(
    () => ({
